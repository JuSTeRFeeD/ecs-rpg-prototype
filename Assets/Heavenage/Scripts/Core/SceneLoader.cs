...
namespace Heavenage.Scripts.Core
{
    public class SceneLoader
    {
        ...
        public SceneLoader(LifetimeScope currentScope, CanvasGroup loadingCanvasGroup, ICoroutineRunner coroutineRunner)
        {
        ...
        {
            return _coroutineRunner.StartCoroutine(LoadSceneAsync(sceneName, () => true));
        }
